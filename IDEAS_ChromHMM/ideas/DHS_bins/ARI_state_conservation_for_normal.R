...
setwd("/data/zusers/fankaili/ideas/dhs_bins/normal_bins/66samples_10marks_normal_bins_result/")
...
dat = NULL
for(i in c(1:19,"X","Y")){
  file = paste("66samples_10marks_normal_bins.chr",i,".state", sep="")
...
pdf(paste("/data/zusers/fankaili/ideas/dhs_bins/normal_bins/ari/ARI_state_conservation_200bp_",state_num,".pdf",sep=""))
