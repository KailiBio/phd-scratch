...
# -- Kaili
# This script is for making aggregation plot for the average of all samples.

############
setwd("/Users/Kaili/Dropbox (UMass Medical School)/Project/chr_status/ideas/dhs_bins/aggregation_average_signal/")
library(ggplot2)
library(grid)
library(gridExtra)
...
##################
assay=assay_list[1]
dhs_ocr = paste(assay, "_average_signal_dhs.txt", sep="")
normal = paste(assay, "_average_signal_normal.txt", sep="")
#
...
##################
outfile = paste("all_sample_average_aggregation.pdf", sep="")
lay = rbind(c(1,1,2,2,3,3),
            c(4,4,5,5,6,6),
            c(7,7,8,8,9,9),
            c(10,10,10,11,11,11))
p = grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, ncol=3,layout_matrix = lay)
ggsave(outfile,p, width = 12, height = 15)
ggsave("all_sample_average_aggregation.png",p, width = 12, height = 15)
##################
