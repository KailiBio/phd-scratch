...
# -- Kaili
# This script is for getting version 1 DHS-center bins.
...
# EXP: python DHS-center_bins_v1.py /data/zusers/fankaili/ideas/dhs_bins/mm10-rOCRs.bed
...
if __name__ == "__main__":
    ...
    with open(dhs_file) as f1:
        cut_bins(f1, output, "O", with_small_bins=0)

    with open(dhs_gap_file) as f2:
        cut_bins(f2, output, "G", with_small_bins=0)
