...
# 1. get CTCF singal in CTCF peaks.
bigBedToBed /data/projects/encode/data/ENCSR397RHW/ENCFF735TCQ.bigBed liver_14.5_day_CTCF_peak.bed
...
intersectBed -a liver_14.5_day_CTCF_peak_over32.bed -b mm10_CTCF_motif_region.bed -wa | sort -u > \
liver_14.5_day_CTCF_peak_over32_withMotif.txt
...
## states
intersectBed -a mm10_ctcf_state_liver14.5_sorted.bed -b liver_14.5_day_CTCF_peak_over32.bed -wa | sort -u | wc -l
intersectBed -a mm10_ctcf_state_liver14.5_sorted.bed -b liver_14.5_day_CTCF_peak.bed -wa | sort -u | wc -l
awk '{FS=" ";OFS="\t"}{print $1,$2,$3,$4}' mm10.bed > mm10_tab.bed
intersectBed -a mm10_tab.bed -b liver_14.5_day_CTCF_peak.bed -wa | sort -u | wc -l
intersectBed -a mm10_tab.bed -b liver_14.5_day_CTCF_peak_over32.bed -wa | sort -u | wc -l
...
# 4. CTCF states with CTCF motifs
## 1) contingency table
intersectBed -a mm10_tab.bed -b mm10_CTCF_motif_region.bed -wa | sort -u | wc -l
intersectBed -a mm10_ctcf_state_liver14.5_sorted.bed -b mm10_CTCF_motif_region.bed -wa | sort -u | wc -l
...
intersectBed -a mm10_ctcf_state_liver14.5_sorted.bed -b mm10_CTCF_motif_region.bed -wa | cut -f 1-4 | sort -u | \
sort -k1,1 -k2,2n > mm10_ctcf_state_liver14.5_ctcf_motif.bed
### CTCF states without CTCF motif
intersectBed -a mm10_ctcf_state_liver14.5_sorted.bed -b mm10_CTCF_motif_region.bed -wa -v | cut -f 1-4 | sort -u | \
sort -k1,1 -k2,2n > mm10_ctcf_state_liver14.5_non_ctcf_motif.bed
### non-CTCF states with CTCF motif
intersectBed -a mm10_tab.bed -b mm10_ctcf_state_liver14.5_sorted.bed -wa -v > mm10_liver14.5_non_ctcf_state.bed
intersectBed -a mm10_liver14.5_non_ctcf_state.bed -b mm10_CTCF_motif_region.bed -wa | cut -f 1-4 | sort -u | \
sort -k1,1 -k2,2n > mm10_non_ctcf_state_liver14.5_ctcf_motif.bed
### get signal
bigWigAverageOverBed /data/projects/encode/data/ENCSR397RHW/ENCFF900YUX.bigWig \
...
> liver_14.5_day_ctcf_signal.txt
