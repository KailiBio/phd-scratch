...
# -- Kaili
# This script is for getting mouse rep2 CTCF data.
...
if __name__ == "__main__":
    ...
    outpath = "/data/zusers/fankaili/ideas/ENCODE_mouse_rep2_CTCF_filelist.txt"
    ...
    for line in open(datalist).readlines():
        ...
        for myfile in myexp.files:
            if myfile.output_type=="signal p-value" and myfile.file_format=="bigWig" and myfile.bio_rep==[2] and myfile.assembly=="mm10" and myfile.file_status=="released":
                ...
                print >> outfile, ("\t").join(["CTCF", "rep2", expID, fileID])
