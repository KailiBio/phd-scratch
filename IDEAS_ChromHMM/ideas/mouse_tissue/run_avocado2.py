...
# with CTCFmotif and CTCFaverage
...
marks = ['H3K4me1', 'H3K4me2', 'H3K4me3', 'H3K9me3', 'H3K9ac', 'H3K27me3', 'H3K27ac','H3K36me3', 'ATAC', 'CTCF', 'DNAme', 'CTCFmotif', 'CTCFaverage']
...
for sample, mark in itertools.product(samples, marks):
    ...
    if sample == 'lung_14.5' and mark == 'CTCF':
        continue
    if mark=='CTCFmotif':
        filename= '/data/zusers/fankaili/ideas/imputation_comparison/mm10_chr19_25bp_bin_CTCFmotifScore.npz'
    elif mark=='CTCFaverage':
        filename= '/data/zusers/fankaili/ideas/imputation_comparison/chr19_25bp_9sample_averageCTCFsignal.npz'
    else:
