...
# -- Kaili
# This script is for getting mouse rep2 histone marks data.
...
if __name__ == "__main__":
    ...
    outpath="/data/zusers/fankaili/ideas/ENCODE_mouse_rep2_8HM_filelist.txt"
    ...
    for i in range(len(data)):
        if data[i]['assay_term_name']=='ChIP-seq':
        	...
        	if myfile.output_type=="signal p-value" and myfile.file_format=="bigWig" and myfile.bio_rep==[2] and myfile.assembly=="mm10" and myfile.file_status=="released":
        	    fileID = myfile.fileID
                    print >> outfile, ("\t").join([sample, data[i]['label'], "rep2", expID, fileID])
