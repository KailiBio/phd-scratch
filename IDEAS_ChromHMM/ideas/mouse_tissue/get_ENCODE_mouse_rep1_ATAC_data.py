...
if __name__ == "__main__":
    expURL = "https://www.encodeproject.org/search/?type=Experiment&status=released&assay_title=ATAC-seq&assay_slims=DNA+accessibility&replicates.library.biosample.donor.organism.scientific_name=Mus+musculus&biosample_type=tissue&lab.title=Bing+Ren%2C+UCSD&limit=all&format=json"
    outpath = "/data/zusers/fankaili/ideas/ENCODE_mouse_rep1_ATAC_filelist.txt"
