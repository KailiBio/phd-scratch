...
# -- Kaili
# This script is for getting mouse rep2 DNAme data.
...
if __name__ == "__main__":
    ...
    outpath="/data/zusers/fankaili/ideas/ENCODE_mouse_rep2_DNAme_filelist.txt"
    ...
    for i in range(len(data)):
        if data[i]['assay_term_name']=='whole-genome shotgun bisulfite sequencing':
            ...
            for myfile in myexp.files:
                if myfile.file_format=="bed" and myfile.output_type=="methylation state at CpG" and myfile.bio_rep==[2] and myfile.assembly=="mm10" and myfile.file_status=="released":
                    fileID = myfile.fileID
                    print >> outfile, ("\t").join([sample, "DNAme", "rep2", expID, fileID])
