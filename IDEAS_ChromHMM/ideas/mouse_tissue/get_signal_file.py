...
if __name__ == "__main__":
    ...
    codeDir = "/data/zusers/fankaili/ideas/get_macs2_pvalue_signal_code.sh"
    ...
    for exp in q.getExps(url):
        if exp.biosample_term_name in tissue_list:
            ...
            code.append("cp /data/projects/encode/data/"+expID+"/"+fileID+".bw > /tmp/"+expID+"/"+fileID+".bw"+"\n")
            code.append("bigWigAverageOverBed /tmp/"+expID+"/"+fileID+".bw /data/zusers/fankaili/ideas/run_ideas_p_value/mm10_tab.bed /data/zusers/fankaili/ideas/signal/macs2_pvalue/"+sample+"_"+mark+"_macs2_pvalue.tab"+"\n")
            if mark=="WGBS":
            ...
            code.append("rm /tmp/"+expID+"/"+fileID+".bw"+"\n")
            # input
