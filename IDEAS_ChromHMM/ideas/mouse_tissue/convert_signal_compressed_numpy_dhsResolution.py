...
for sample, mark in itertools.product(samples, marks):
    inputfile = '/data/zusers/fankaili/ideas/signal/rep1_signal_chr19_25bp_dhsResolution/{}_{}_dhs.txt'.format(sample, mark)
    outputfile = '/data/zusers/fankaili/ideas/signal/rep1_signal_chr19_25bp_dhsResolution/{}_{}_dhs_chr19_25bp'.format(sample, mark)
