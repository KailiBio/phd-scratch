...
#
awk '{FS=OFS="\t"}{if(NR<451){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_1.sh
awk '{FS=OFS="\t"}{if(NR>(1*450) && NR<(2*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_2.sh
awk '{FS=OFS="\t"}{if(NR>(2*450) && NR<(3*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_3.sh
awk '{FS=OFS="\t"}{if(NR>(3*450) && NR<(4*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_4.sh
awk '{FS=OFS="\t"}{if(NR>(4*450) && NR<(5*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_5.sh
awk '{FS=OFS="\t"}{if(NR>(5*450) && NR<(6*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_6.sh
awk '{FS=OFS="\t"}{if(NR>(6*450) && NR<(7*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_7.sh
awk '{FS=OFS="\t"}{if(NR>(7*450) && NR<(8*450+1)){print $0}}' codes_for_getting_signal_bam.sh > ./code/codes_for_getting_signal_bam_8.sh
