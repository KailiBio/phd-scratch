...
setwd("/Users/kaili/Dropbox (UMass Medical School)/Project/ccRE/hg38_rOCR/v28_comprehensive_protein/")
library(ggplot2)
library(grid)
library(gridExtra)
...
ggsave("fig1.comprehensive_v28_protein_coding.pdf", p)
...
ggsave("fig2.comprehensive_v28_protein_coding.pdf", p, width = 10)
...
p2
ggsave("fig3.distance_histogram_zoomin_comprehensive_v28_protein_coding.pdf", p2)
#
p3 = ggplot(dat, aes(y=distance, x=type1, fill=type1)) + 
  ...
  labs(title="distance to neasest TSS in same gene")
p3
ggsave("fig3.distance_boxplot_comprehensive_v28_protein_coding.pdf", p3)

p4 = p3 + coord_cartesian(ylim = c(0, 150))
p4
ggsave("fig3.distance_boxplot_zoomin_comprehensive_v28_protein_coding.pdf", p4)

####
tss_count = read.table("hg38_v28_comprehensive_gene_labled_TSScount_protein_coding.bed")
...
ggsave("fig3.boxplot_number_of_TSSs_comprehensive_v28_protein_coding.pdf")
