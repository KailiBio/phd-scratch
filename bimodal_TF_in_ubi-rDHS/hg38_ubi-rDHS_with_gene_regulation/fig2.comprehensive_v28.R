...
setwd("/Users/kaili/Dropbox (UMass Medical School)/Project/ccRE/hg38_rOCR/fig2/comprehensive_v28/")
library(ggplot2)
library(grid)
library(gridExtra)
...
p1
ggsave("fig2.TSindex_density_1_comprehensive_v28.pdf")
...
p2
ggsave("fig2.TSindex_density_2_comprehensive_v28.pdf")
...
ggsave("fig2.TSindex_density_comprehensive_v28.pdf", p, width = 10)
#####################
