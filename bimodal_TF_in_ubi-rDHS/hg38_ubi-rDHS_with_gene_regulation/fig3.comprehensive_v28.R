...
setwd("/Users/kaili/Dropbox (UMass Medical School)/Project/ccRE/hg38_rOCR/fig3/comprehensive_v28/")
library(ggplot2)
...
p1
ggsave("fig3.distance_histogram_comprehensive_v28.pdf", p1)
ggsave("fig3.distance_histogram_comprehensive_v28.png", p1)

p2 = p1+ coord_cartesian(xlim=c(0,500))
p2
ggsave("fig3.distance_histogram_zoomin_comprehensive_v28.pdf", p2)
...
p3 = ggplot(dat, aes(y=distance, x=type1, fill=type1)) + 
  ...
  labs(title="distance to neasest TSS in same gene")
p3
ggsave("fig3.distance_boxplot_comprehensive_v28.pdf", p3)

p4 = p3 + coord_cartesian(ylim = c(0, 150))
p4
ggsave("fig3.distance_boxplot_zoomin_comprehensive_v28.pdf", p4)
