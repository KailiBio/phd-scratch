...
###################
# 1. DNase
bash ${autoScriptDir}get_DNase_signal_two_groups.sh ${DNase_signal_path} ${rOCRs_file} ${ubi_rOCRs_file} \
${non_ubi_outPath} ${outPath}
...
bash ${autoScriptDir}get_RNAseq_signal_two_groups.sh ${gene_labeled_file} ${tss_labeled_file} ${exp_signal_path} \
${non_ubi_outPath} ${outPath}
