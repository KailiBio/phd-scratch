...
setwd("/Users/kaili/Dropbox (UMass Medical School)/Project/ccre/bimodal_tf_rdhs/data_figure/hg38/")
...
hist(data[,1], breaks=200, xlab = "tissue specificity index", main = "Xiaoou's mouse data\n(66 samples)")
