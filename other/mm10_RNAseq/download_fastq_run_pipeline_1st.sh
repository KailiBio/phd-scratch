...
echo bash /data/zusers/fankaili/github/weng-lab/Kaili/other/mm10_RNAseq/run_RNAseq_pipeline_1st.sh ${workDir}rna_exp/${expID}/${fileIDs}.fastq "" ${STARgenomeDir} ${RSEMrefDir} ${dataType} 8 8 ${workDir}rna_exp/${expID}/${fileIDs}/ ${fileIDs}
bash /data/zusers/fankaili/github/weng-lab/Kaili/other/mm10_RNAseq/run_RNAseq_pipeline_1st.sh ${workDir}rna_exp/${expID}/${fileIDs}.fastq "" ${STARgenomeDir} ${RSEMrefDir} ${dataType} 8 8 ${workDir}rna_exp/${expID}/${fileIDs}/ ${fileIDs}
